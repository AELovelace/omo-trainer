...
for (const name of ['style.css', 'app.js', 'merge.js', 'account.js', 'crt-init.js', 'pwa.js', 'icons/icon-192.png', 'icons/icon-512.png']) {
...
await import('./embed-growth-chart.mjs'); // Regenerate the in-app chart whenever source assets are imported.
