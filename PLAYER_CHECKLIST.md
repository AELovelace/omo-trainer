...
- In **Record a wetting**, classify each actual event once as Forced, Voluntary, Semi-involuntary, or Involuntary, including events without a roll. The diaper total is saved with this wetting, but daily classification totals still count it as just one event.
