...
export function toCsv(entries) { // Exports all selected snapshots with explicit units, offsets, provenance, and escaped CSV cells.
  const columns = ['occurredAt', 'liquidsMl', 'position', 'diaperNumber', 'wettingsCount', 'probability', 'result', 'source', 'edited', 'kind', 'category', 'rolledAt', 'rolledResult', 'protocolVersion', 'timeZone', 'lastFailureAt', 'liquidsMode', 'desperation', 'baseProbability', 'probabilityModifier', 'rollRuleVersion', 'desperationMode', 'lastFailureDesperationMode'];
