...
export const ENTRY_FIELDS = ['id','kind','occurredAt','liquidsMl','liquidsMode','position','diaperNumber','wettingsCount','probability','result','source','edited','category','rolledAt','rolledResult','protocolVersion','timeZone','lastFailureAt'];
