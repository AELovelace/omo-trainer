...
function render() { // Show immutable bonus receipts beside current statistics, which can reflect later record corrections.
  ...
  $('#bonus-status').textContent=(data.checkedInToday?'Today is checked in!':'Save and sync liquids, a wetting, a diaper change or a roll to check in today.')+` Days use ${data.timeZone}.`;
