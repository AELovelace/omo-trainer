...
function controls() {
 for(const id of ['social-likes','social-comments','friend-posts','friend-wettings','friend-changes','friend-liquids','direct-messages'])$('#notification-'+id).disabled=busy||!config;
