...
function payload(sub) {return {subscription:sub.toJSON(),timeZone:timezone(),quietStart:Number($('#notification-quiet-start').value),quietEnd:Number($('#notification-quiet-end').value),adminMessages:$('#notification-admin-messages').checked,communitySupport:$('#notification-community-support').checked,communityAnonymous:$('#notification-community-anonymous').checked};}
