...
export function dayAdjustment(counts) { // Empty days increase the chance; nonempty ties decrease it by five percentage points.
  const deliberate = counts.forced + counts.voluntary;
