...
function reset(){clearViews();$('#status-view-post').hidden=true;$('#status-view-post').href='#feed';$('#post-status').textContent='Sign in to post an update.';account=null;pictures=[];peer='';activityBefore=null;activityNext=null;postRetry=null;messageRetry=null;feedBefore=null;messageBefore=null;$('#status-text').value='';$('#status-audience').value='friends';$('#status-pictures').value='';$('#status-picture-preview').replaceChildren();$('#message-text').value='';buttons();}
...
function visible(){if(route()==='#post')void loadComposer();if(route()==='#feed')void loadFeed();if(route()==='#messages')void loadChat();if(route()==='#activity')void loadActivity();}
