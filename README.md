...
2. **Publish shared authentication:** configure DNS and HTTPS for **auth.lidoll.dev**, and use [nginx-auth.conf](deploy/nginx-auth.conf) inside that HTTPS server block. It forwards to **10.1.1.23:4180**.
