const CACHE = `little-log-v100-social-account-gate-${self.registration.scope}`; // Install the fullscreen viewer with the app; private API responses are never cached.
