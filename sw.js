const CACHE = `little-log-v87-notifications-shortcut-${self.registration.scope}`; // Install reactions, activity and notification settings together; private API responses are never cached.
