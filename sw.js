const CACHE = `little-log-v93-pet-cleanup-${self.registration.scope}`; // Install reactions, activity and notification settings together; private API responses are never cached.
