const CACHE = `little-log-v97-record-notification-filters-${self.registration.scope}`; // Install timeline settings with the app; private API responses are never cached.
...
SHELL.push('./lib/record-sharing.js'); // Opt-in controls remain in the shell while account preferences require a live connection.
