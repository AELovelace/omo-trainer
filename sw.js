const CACHE = `little-log-v71-desperation-mode-${self.registration.scope}`; // Upgrade offline clients together so saved halved rolls and longer cooldowns are understood.
