const CACHE = `little-log-v86-photo-resizing-${self.registration.scope}`; // Install reactions, activity and notification settings together; private API responses are never cached.
