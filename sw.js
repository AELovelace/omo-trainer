const CACHE = `little-log-v94-compact-social-${self.registration.scope}`; // Install reactions, activity and notification settings together; private API responses are never cached.
