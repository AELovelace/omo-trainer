const CACHE = `little-log-v72-diaper-wording-${self.registration.scope}`; // Refresh cached pages and scripts so offline clients receive the updated diaper wording.
